---
title: "Interactive Monitoring Panel for Student Risk"
sidebarTitle: "Panel Monitoreo"
description: "The monitoring panel displays all students with their 🟢/🟡/🔴/⚪ risk levels, AI-generated explanations, and pedagogical recommendations."
---
...
The monitoring panel includes a persistent left sidebar on desktop (`lg:flex`) and a bottom navigation bar on mobile. All four main pages are reachable from either:
